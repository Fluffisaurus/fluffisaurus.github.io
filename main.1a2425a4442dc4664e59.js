...
function CustomOptionsDial() {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(react_toastify_1.ToastContainer, { position: "bottom-left", autoClose: 5000, limit: 3, hideProgressBar: false, newestOnTop: false, closeOnClick: false, pauseOnFocusLoss: true, draggable: true, pauseOnHover: true, theme: mode == "system" ? systemMode : mode, transition: react_toastify_1.Slide }),
